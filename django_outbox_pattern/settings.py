...
DEFAULT_PRODUCER_PROCESS_MSG_ON_BACKGROUND = DJANGO_OUTBOX_PATTERN.get(
    "DEFAULT_PRODUCER_PROCESS_MSG_ON_BACKGROUND", False
)
DEFAULT_CONSUMER_PROCESS_MSG_WORKERS = DJANGO_OUTBOX_PATTERN.get("DEFAULT_CONSUMER_PROCESS_MSG_WORKERS", 1)
DEFAULT_PRODUCER_PROCESS_MSG_WORKERS = DJANGO_OUTBOX_PATTERN.get("DEFAULT_PRODUCER_PROCESS_MSG_WORKERS", 1)
