...
DEFAULT_CONSUMER_SHUTDOWN_TIMEOUT = DJANGO_OUTBOX_PATTERN.get("DEFAULT_CONSUMER_SHUTDOWN_TIMEOUT", 90)
DEFAULT_CONSUMER_MAX_RETRY_ATTEMPTS = DJANGO_OUTBOX_PATTERN.get("DEFAULT_CONSUMER_MAX_RETRY_ATTEMPTS", 3)
DEFAULT_CONSUMER_RETRY_WAIT = DJANGO_OUTBOX_PATTERN.get("DEFAULT_CONSUMER_RETRY_WAIT", 2)
